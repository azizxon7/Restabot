...
from aiogram.types import ReplyKeyboardMarkup, ReplyKeyboardRemove, KeyboardButton, InlineKeyboardMarkup, \
    InlineKeyboardButton, ContentType, BotCommand, BotCommandScopeDefault

api = '5837732357:AAF6K39mi6E0wYxp-Fxen-uxHJRbyDVkXEA'
...
async def b(message: types.message):
    ...
    if message.text == '🍜 Suyuq ovqatlar':
        ...
        btn6 = '🔚 Asosiy bo\'lim'
        btns4 = ReplyKeyboardMarkup(one_time_keyboard=True, resize_keyboard=True).add(butn1, butn2, butn3, butn4).add(
            btn5, btn6)
    ...
    if message.text == '🍝 Qo\'yiq ovqatlar':
        ...
        btn5 = '📝 Kategoriyaga qaytish'
        btn6 = '🔚 Asosiy bo\'lim'
        btns5 = ReplyKeyboardMarkup(one_time_keyboard=True, resize_keyboard=True).add(butn1, butn2, butn3).add(btn5,
                                                                                                               btn6)
    ...
    if message.text == '🍔 Fast-Food':
        ...
        btn5 = '📝 Kategoriyaga qaytish'
        btn6 = '🔚 Asosiy bo\'lim'
        btns5 = ReplyKeyboardMarkup(one_time_keyboard=True, resize_keyboard=True).add(butn1, butn2, butn3, butn4,
                                                                                      butn5).add(btn5, btn6)
        await message.answer(message.text, reply_markup=btns5)
